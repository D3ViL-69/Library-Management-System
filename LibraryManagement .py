...
def main():
    ...
    frame1 = Frame(root, bg='Powder Blue', padx=5, pady=5, bd=10, relief=RIDGE)
    frame1.pack(side=TOP)
    frame12 = Frame(root, bg='Powder Blue', padx=5,
                    pady=5, bd=10, relief=RIDGE)
    frame12.pack(side=LEFT)
    frame13 = Frame(root, bg='Powder Blue', padx=5,
                    pady=5, bd=10, relief=RIDGE)
    ...
    frame21 = Frame(root, bg='Powder Blue', padx=5,
                    pady=5, bd=10, relief=RIDGE)
    frame21.pack(side=BOTTOM)
    # ====================================================
    labtit = Label(frame1, text='Library Management System',
...
def login():
    if user_name.get() == "" or password.get() == "":
        ...
        try:
            ...
            cur.execute(
                f"select * from user_information where username='{user_name.get()}' and password = '{password.get()}'")
            row = cur.fetchone()
    ...
    def action():
        if age.get() == "" or add.get() == "" or user_name.get() == "" or password.get() == "" or very_pass.get() == "":
            ...
            if row != None:
                ...
                cur.execute("insert into user_information(age,gender,address,username,password) values(?,?,?,?,?)",
                            (
                                age.get(),
                                var.get(),
                                add.get(),
...
#def forget():
    ...
    Radio_button_male = ttk.Radiobutton(
        winsignup, text='Male', value="Male", variable=var).place(x=200, y=220)
    Radio_button_female = ttk.Radiobutton(
...
#forget_btn =  Button(win, text="Forgot Password", command=forget)
#forget_btn.place(x=100,y=300)
